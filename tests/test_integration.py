...
from mohflow.context.enrichment import set_request_context, with_request_context
...
class TestMohflowLoggerIntegration:
    ...
    def test_logger_with_auto_config_and_context_enrichment(self):
        ...
        with patch('mohflow.auto_config.AutoConfigurator.detect_environment') as mock_detect:
            ...
            with set_request_context(request_id="req-123", user_id="user-456"):
                with patch('sys.stdout') as mock_stdout:
                    ...
                    # This would require checking the log output format
    ...
    def test_context_correlation_across_async_operations(self):
        ...
        threads = []
        for i in range(3):
            thread = threading.Thread(target=simulate_async_operation, args=(i,))
    ...
    def test_loki_integration_with_enhanced_features(self, mock_post):
        ...
        with set_request_context(request_id="req-loki-test"):
            logger.info("Test message for Loki",
                       user_id="user-123",
