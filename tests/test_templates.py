...
class TestTemplateManager:
    ...
    def test_get_available_templates(self, mock_listdir, mock_exists):
        ...
        expected = ['application_logs', 'error_tracking', 'performance_metrics']
    ...
    def test_deploy_grafana_dashboard_success(self, mock_load_template, mock_post):
    ...
    @patch('requests.post')
    @patch.object(TemplateManager, 'load_template')
    def test_deploy_grafana_dashboard_with_datasource(self, mock_load_template, mock_post):
        ...
        assert posted_data["dashboard"]["panels"][0]["datasource"] == "Custom-Loki"

    @patch('requests.post')
    @patch.object(TemplateManager, 'load_template')
    def test_deploy_grafana_dashboard_failure(self, mock_load_template, mock_post):
    ...
    @patch('requests.post')
    @patch.object(TemplateManager, 'load_template')
    def test_deploy_kibana_dashboard_success(self, mock_load_template, mock_post):
    ...
    @patch('requests.post')
    @patch.object(TemplateManager, 'load_template')
    def test_deploy_kibana_dashboard_with_index_pattern(self, mock_load_template, mock_post):
        ...
        index_pattern_obj = next(
            obj for obj in posted_data["objects"] 
    ...
    @patch('requests.post')
    @patch.object(TemplateManager, 'load_template')
    def test_deploy_kibana_dashboard_failure(self, mock_load_template, mock_post):
    ...
    def test_check_kibana_connectivity(self, mock_get):
        ...
        result = self.manager._check_kibana_connectivity("http://localhost:5601")
