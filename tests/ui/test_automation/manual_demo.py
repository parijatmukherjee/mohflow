...
def demo_import_structure():
    ...
    try:
        ...
        try:
            ...
            print_status("✓ LogGenerator imported", "SUCCESS")
        except ImportError as e:
            print_status(
                f"⚠️ LogGenerator import (expected in module context): {e}",
                "WARNING",
            )
        ...
        try:
            ...
            print_status(
                "⚠️ Selenium not available (browser tests will be skipped)",
                "WARNING",
            )
        ...
        try:
            ...
            print_status(
                "⚠️ FastAPI not available (hub tests will fail)", "WARNING"
            )
