...
class TracePropagationMiddleware:
    ...
    def inject_to_headers(
        ...
        updated_headers = inject_trace_context(headers, ctx, self.propagator_types)
    ...
    def create_child_context(self, parent_ctx: Optional[Any] = None) -> Optional[Any]:
    ...
    try:
        class OpenTelemetryMiddleware:
            ...
            def __call__(self, request):
                ...
                ctx = self.propagation_middleware.extract_from_headers(clean_headers)
