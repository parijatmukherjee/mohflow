...
class FrameworkDetector:
    ...
    def detect_frameworks(self, force_refresh: bool = False) -> List[FrameworkInfo]:
        """
            ...
            django_info = FrameworkInfo(
                ...
                custom_config={
                    ...
                    "context_enrichment": {
                        "include_request_context": True,
                        "custom_fields": {
                            "django_version": self._get_module_version('django')
                        }
                    }
                }
            )
    ...
    def _determine_deployment_type(self, frameworks: List[FrameworkInfo], app_type: str) -> str:
        """Determine deployment architecture type."""
        framework_names = {f.name.lower() for f in frameworks}
        
        # Serverless indicators
        if os.getenv('AWS_LAMBDA_FUNCTION_NAME') or os.getenv('FUNCTIONS_WORKER_RUNTIME'):
            return "serverless"
    ...
    def _detect_cache_usage(self) -> bool:
        ...
        return any(self._is_module_available(module) for module in cache_modules)
    ...
    def _get_app_type_config(self, app_info: ApplicationInfo) -> Dict[str, Any]:
    ...
    def _get_performance_config(self, app_info: ApplicationInfo) -> Dict[str, Any]:
    ...
    def _get_integration_config(self, app_info: ApplicationInfo) -> Dict[str, Any]:
        ...
        if app_info.has_database:
            ...
            config["context_enrichment"]["custom_fields"]["has_database"] = True
